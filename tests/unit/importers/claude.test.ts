...
describe('ClaudeImporter', () => {
  ...
  describe('import', () => {
    it('should import minimal fixture', async () => {
      const fixturePath = resolve(__dirname, '../../fixtures/conversations/minimal.json')
      const conversations = []
    ...
    it('should normalize conversation metadata', async () => {
      ...
      expect(first.summary).toBe('A simple test conversation about programming')
  ...
  describe('edge cases', () => {
    it('should handle empty text field with content array', async () => {
      const fixturePath = resolve(__dirname, '../../fixtures/conversations/edge-cases.json')
      const conversations = []
    ...
    it('should extract attachment extracted_content', async () => {
      ...
      expect(thirdMessage.text).toContain('This is the content of the attached file')
    ...
    it('should not duplicate text from content array', async () => {
      ...
      const firstMessage = conversations[0].messages[0]
      const occurrences = (firstMessage.text.match(/What is TypeScript\?/g) || []).length
